...
\[\overline{a_{1i}} = \overline{\bm{L}_2} \frac{\partial}{\partial{a_{1i}}} \bm{L}_2\]
\[\overline{a_{1i}} = \overline{\bm{L}_2} \frac{\partial}{\partial{a_{1i}}} \sum_{j} w_{2j}a_{1j}\]
\begin{equation}
...
\[\overline{w_{1i}} = \overline{\bm{L}_1} \frac{\partial}{\partial{w_{1i}}} \bm{L}_1\]
\[\overline{w_{1i}} = \overline{\bm{L}_1} \frac{\partial}{\partial{w_{1i}}} \sum_{j} w_{1j}\bm{x}_{1j}\]
\begin{equation}
    \overline{w_{1i}} = \overline{\bm{L}_1} x_{1i}
\end{equation}
\paragraph
