...
\[\overline{\bm{l}_2} = \overline{a_2} \frac{\partial}{\partial{\bm{l}_2}} \bm{a}_2\]
\[\overline{\bm{l}_2} = \overline{a_2} \frac{\partial}{\partial{\bm{l}_2}} \text{ReLU}(\bm{l}_2)\]
\[\overline{\bm{l}_2} = \overline{a_2} \theta(\bm{l}_2) \cdot 1\]
\begin{equation}\overline{\bm{l}_2} = \overline{a_2} \theta(\bm{l}_2) \end{equation}
